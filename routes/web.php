...
Route::get('product-list',[FrontEndController::class,'searchajax']);
...
Route::middleware(['auth'])->group(function(){
   ...
   Route::get('add-review/{prodname}/userreview',[ReviewController::class, 'add']);
   Route::post('add-review', [ReviewController::class, 'create']);
   Route::get('edit-review/{prodname}/userreview', [ReviewController::class,'edit']);
...
Route::middleware(['auth','isAdmin'])->group(function(){
    ...
    Route::put('update-order/{id}',[OrderController::class,'updatedorder']);
